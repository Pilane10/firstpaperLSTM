...
from logdeep.models.LstmTcn import LstmTcn
...
options['weight_decay'] = 1e-5 #0.0015
options['lr_step'] = (5, 10)  # Decay after 5 epochs
options['lr_decay_ratio'] = 0.5  # More aggressive decay


options['resume_path'] = None
options['model_name'] = "lstmTcn2"
options['save_dir'] = options["output_dir"] + "lstmTcn2/"
...
Model = LstmTcn(input_size=options['input_size'],
