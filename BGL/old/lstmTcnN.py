...
from logdeep.models.LstmTcnND import LstmTcnWithoutAttention
...
options['num_layers'] = 4   #2
options["embedding_dim"] = 150 #128
...
options['dropout'] = 0  # set to 0 to Disable dropout
options['use_layer_norm'] = True  # Disable layer normalization
...
options['model_name'] = "LstmTcnNoAttentionNormalization"
options['save_dir'] = options["output_dir"] + "LstmTcnNoAttentionNormalization/"
...
Model = LstmTcnWithoutAttention(input_size=options['input_size'],
