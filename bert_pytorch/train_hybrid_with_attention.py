# train_hybrid_with_attention.py
import sys
sys.path.append('.') # Add project root to path
from logdeep.models.lstm_bi_gru_hybrid import HybridLSTMBiGRU
from logdeep.tools.train_hybrid_Sa import Trainer # Assuming you saved the with-attention trainer here
import pickle
import argparse

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train Hybrid LSTM-BiGRU with Attention')
    ...
    parser.add_argument('--save_dir', type=str, default='output/bgl/hybrid_with_attention/', help='Path to save model')
